...
const Footer: React.FC<FooterProps> = ({ className = '' }) => {
    ...
    const isSpecialPage = component === 'SLF' || component === 'PBG';
    const fillClass = isSpecialPage ? 'fill-white' : 'fill-hijauwhy';
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-4">
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center text-white">
                                    ...
                                    <span className="text-sm">marketing@izingedung.id</span>
                                </div>
                                <div className="flex items-center text-white">
                                    <svg className="mr-3 h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="flex space-x-4">
                                <a
                                    href="https://www.linkedin.com/in/izin-gedung-8a09b3383/"
                                    target="_blank"
                                ...
                                <a
                                    href="https://www.instagram.com/izingedung.id/"
                                    target="_blank"
                                    className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-orange-500 transition-colors hover:bg-gray-100"
                                >
                                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
